<template>
  <div  class="bg-white shadow rounded-xl transition-all hover:scale-105 " >
    ...
    <div class="p-3">
      ...
      <template v-for="author in book.authors" :key="author.displayName">
        <h3 class="dark:text-black">{{ author.displayName }}</h3>
      </template>
      <p class="mb-4 dark:text-black"> {{ book.shortDescription }}</p>
